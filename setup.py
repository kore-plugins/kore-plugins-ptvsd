...
init_path = os.path.join('kore_plugins_ptvsd', '__init__.py')
...
entry_points = """\
[kore.components]
kore.components.ptvsd = kore_plugins_ptvsd.plugins.ptvsd:PtvsdPlugin
"""


setup(
    name='kore-plugins-ptvsd',
    version=metadata['version'],
    author=metadata['author'],
    author_email=metadata['email'],
    url=metadata['url'],
    packages=find_packages(include=('kore_plugins_ptvsd*',)),
